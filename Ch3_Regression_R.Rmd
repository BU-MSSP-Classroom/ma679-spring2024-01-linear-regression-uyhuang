...
Your answer:
No, not all the predictors should be included. Here Full Bath has a p-value=0.121>0.05, so it is not statistically significant. So I use Anova to compare with and without the predictor. From the result we can see that the predictor doesn't provide much help in the model. 
